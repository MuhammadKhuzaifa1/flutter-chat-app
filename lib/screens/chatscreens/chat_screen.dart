...
import 'call_screen/call_buttons.dart';
...
class _chatScreenState extends State<chatScreen> with WidgetsBindingObserver {
  ...
  late Future<DocumentSnapshot?> getUserDocumentFuture;
  ...
  void initState() {
    ...
    getUserDocumentFuture = _getUserDocument();
    valueNotifier = ValueNotifier<String>(widget.senderId ?? "");
  }
  ...
  Future<DocumentSnapshot?> _getUserDocument() async {
    ...
    if (user != null) {
      String targetDocumentId = user.uid;
      try {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: text == 'DarkTheme'
          ...
          : Color.fromRGBO(239, 230, 223, 1),
      appBar: AppBar(
        actions: [
          CallButtons(otherUserId: valueNotifier,recieverName:widget.userName.toString()), // buttons
          ...
          //       child: Icon(
          //         Icons.call,
          //         color: text == 'DarkTheme' ? appColors.white : Colors.black,
          //       )),
          // ),
        ],
        backgroundColor:
        ...
        title: ListTile(
          ...
          subtitle: Text(
            widget.onlinestatus.toString(),
            style: TextStyle(
              color: text == 'DarkTheme' ? appColors.white : Colors.grey,
            ),
          ),
        ),
      ),
