    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        child: CircleAvatar(radius: 27,
            ...
            child: Icon(Icons.message,color: Colors.white,)),backgroundColor: Colors.transparent,
        elevation: 0,
        onPressed: () {},),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                ...
                //   ),
                // ),
                Text("Chat App",style: appTextStyle.normalText(fontweight: FontWeight.w500,fontsize: 25,colors: text == 'DarkTheme'?Colors.white:Colors.black,)),
                Row(
                  children: [
                    ChangeThemeButtonWidget(),
                    SizedBox(width: 4,),
                    Icon(Icons.search,color: text == 'DarkTheme'?Colors.white:Colors.black,),
                    PopupMenuButton(
                      itemBuilder: (ctx) => [
                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (SessionControler().userId == snapshot.data!
                          .docs[index]['id']) {
                        return Container();
                      } else {
                        if (name.isEmpty) {
                            ...
                            child: Column(children: [
                              ListTile(onTap: () {
                                Get.to(chatScreen(
                                  ...
                                  onlinestatus: data['onlineStatus'].toString(),

                                ));
                              },
                                title: Text(data['username'].toString(),
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,color:  text == 'DarkTheme'?Colors.white:Colors.black,)),
                                subtitle: Text("Hello How are you",
                                  style: appTextStyle.normalText(colors: Colors.grey),),
                                leading: Container(
                                  height: 48,
                                  width: 48,
                                  decoration: BoxDecoration(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      errorWidget: (context, url, error) =>
                                            ...
                                            Padding(
                                              ...
                                              child: Image.asset(appImages.profile,fit: BoxFit.cover,color: appColors.person),
                                            ),
