  ...
  void Login(String email, String password,
    ...
    try {
      ...
      if (e.code == 'user-not-found') {
        CommanDialog.showErrorDialog(title: "User not found",description: "No user found for that email.");
        print('No user found for that email.');
      } else if (e.code == 'wrong-password') {
        CommanDialog.hideLoading();
        CommanDialog.showErrorDialog(title: "Incorrect Password",description: "Wrong password Please try again.");
  ...
  void signup(String username, String email, String password,
    ...
    try {
      ...
      if (e.code == 'weak-password') {
        CommanDialog.hideLoading();
        CommanDialog.showErrorDialog(title: "Password Weak",description: "The password provided is too weak.");
        print('The password provided is too weak.');
      } else if (e.code == 'email-already-in-use') {
        CommanDialog.hideLoading();
        print('The account already exists for that email.');
        CommanDialog.showErrorDialog(title: "Account already",description: "The account already exists on your device.");
  ...
  void forgot(String email,
    ...
    try {
      ...
      if (e.code == 'user-not-found') {
        ...
        CommanDialog.showErrorDialog(title: "Oops Error",description: e.toString());
        CommanDialog.hideLoading();
      }
    }
    catch (e) {
...
class siginphoneNumber extends ChangeNotifier{
  ...
  void siginPhone(String? phoneNumber) async{
    ...
    try{
      ...
      auth.verifyPhoneNumber(
          ...
          verificationFailed: (FirebaseAuthException e) {
            if (e.code == 'invalid-phone-number') {
              CommanDialog.hideLoading();
              CommanDialog.showErrorDialog(title: "Oops Error" ,description: 'The provided phone number is not valid.');
              print('The provided phone number is not valid.');
            }else{
              CommanDialog.hideLoading();
              return  CommanDialog.showErrorDialog(title: "Oops Error" ,description: 'Something Wrong');
            }
          },
      ...
      CommanDialog.hideLoading();
      CommanDialog.showErrorDialog(title: "Oop Error",description: e.toString());
